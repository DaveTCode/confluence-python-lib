...
class ConfluenceVersionConflict(ConfluenceError):
    ...
    def __init__(self, path, params, response):
        ...
        msg = 'The given version does not match the expected next version. This is likely because someone else has made a change to the resource at path {}'.format(path)
